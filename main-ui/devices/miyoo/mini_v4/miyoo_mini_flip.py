...
from devices.miyoo.mini_v4.miyoo_mini_v4_shared_memory_writer import MiyooMiniV4SharedMemoryWriter
...
class MiyooMiniV4(MiyooDevice):
    ...
    def __init__(self, device_name, main_ui_mode):
        ...
        if(main_ui_mode):
            ...
            self.miyoo_mini_v4_shared_memory_writer = MiyooMiniV4SharedMemoryWriter()
    ...
    def _set_lumination_to_config(self):
        ...
        #self.miyoo_mini_v4_shared_memory_writer.set_lumination(self.system_config.backlight)
        self.miyoo_mini_v4_shared_memory_writer.set_brightness(self.system_config.backlight)

    def _set_contrast_to_config(self):
        #Doesn't seem to work?
        #self.miyoo_mini_v4_shared_memory_writer.set_contrast(self.system_config.contrast)
        pass
    
    def _set_saturation_to_config(self):
        #Doesn't seem to work?
        #self.miyoo_mini_v4_shared_memory_writer.set_saturation(self.system_config.saturation)
        pass

    def _set_brightness_to_config(self):
        #Doesn't seem to work?
        #self.miyoo_mini_v4_shared_memory_writer.set_brightness(self.system_config.brightness)
        pass
